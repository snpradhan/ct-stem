...
class CurriculumForm(ModelForm):
  ...
  class Meta:
    ...
    fields = ['curriculum_type', 'unit', 'author', 'title', 'icon', 'time', 'level', 'purpose', 'overview', 'student_overview', 'status', 'subject', 'compatible_system', 'taxonomy', 'content', 'teacher_notes', 'shared_with']
