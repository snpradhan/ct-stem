...
urlpatterns = [
    ...
    url(r'^subcategory/new/$', views.subcategory, name='newSubcategory'),
    url(r'^subcategory/search/$', views.searchTaxonomy, name='searchTaxonomy'),
    url(r'^subcategories/(?P<standard_id>[\d]+)/$', views.subcategories, name='subcategories'),
    url(r'^subcategory/delete/(?P<model_type>[\w-]+)/(?P<id>[\d]+)/$', views.deleteSubcategory, name='deleteSubcategory'),
