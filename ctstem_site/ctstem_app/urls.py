...
urlpatterns = [
    ...
    path('curriculum/print/<int:id>/', views.printCurriculum, name='printCurriculum'),
    path('curriculum/print/<int:id>/pem_code/<slug:pem_code>/', views.printCurriculum, name='printCurriculum'),
    ...
    #path('curriculum/print/<int:id>/page/<int:step_order>/', views.printCurriculumActivity, name='printCurriculumActivity'),
    #path('curriculum/print/<int:id>/page/<int:step_order>/pem_code/<slug:pem_code>/', views.printCurriculumActivity, name='printCurriculumActivity'),
