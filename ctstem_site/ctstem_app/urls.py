...
urlpatterns = [
    ...
    url(r'^assignmenttiles/$', views.assignmenttiles, name='assignmenttiles'),
    ...
    url(r'^assignment/realtime_feedback/(?P<assignment_id>[\d]+)/(?P<flag>[\d]+)/$', views.realtime_feedback, name='realtime_feedback'),
